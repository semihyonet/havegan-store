    ...
    <div className="relative bg-white">
      ...
      <div className="relative mx-auto max-w-3xl px-4 pb-96 text-center sm:px-6 sm:pb-0 lg:px-8">
        ...
        <div className="relative py-32">
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">Have it Vegan!</h1>
          <div className="mt-4 sm:mt-6">
            <a
              href="categories/"
              className="inline-block rounded-md border border-transparent bg-green-600 px-8 py-3 font-medium text-white hover:bg-indigo-700"
            >
              Search Categories
            </a>
          </div>
